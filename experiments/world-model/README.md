...
> Consolidation note: this is an isolated research experiment inside
> `arc3-runner`, not the production runner backend. Its pre-consolidation
> history is preserved on `archive/world-model-20260705`.
